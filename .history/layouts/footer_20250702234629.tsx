...
const Footer = ({ active = "home" }) => {
  return (
    <View className="flex-row justify-around items-center bg-white border-t border-gray-200 h-16">
      <TouchableOpacity onPress={()=>router.navigate("../app/index")} className="items-center">
      ...
      <TouchableOpacity onPress={()=>router.navigate("../app/subjects")} className="items-center">
      ...
      <TouchableOpacity onPress={()=>router.navigate("../app/classes")} className="items-center">
      ...
      <TouchableOpacity onPress={()=>router.navigate("../app/profile")} className="items-center">
