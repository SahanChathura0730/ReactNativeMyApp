...
const LoginScreen = () => {
  return (
    <View className="flex-1 bg-[#F1F5F9]">
      {/* Top Section */}
      <View className="bg-[#1E3A8A] h-1/3 rounded-br-[50px] justify-center p-6">
        <Text className="text-white text-4xl font-slabBold">Welcome</Text>
        <Text className="text-blue-200 text-lg mt-2">Login to continue</Text>
      </View>

      {/* Form Section */}
      <View className="flex-1 px-6 mt-[-40px]">
