...
const LoginScreen = () => {
  return (
    <View className="flex-1 bg-white">
      <View className="bg-primary rounded-tr-[50px] justify-center p-6 pt-14 pb-1">
        <Text className="text-white text-5xl font-slab">Welcome</Text>
      </View>
      <View className="bg-secondary justify-center p-6  pt-1 pb-10 pl-7">
        <Text className="text-blue-200 text-2xl font-slabMedium">edu manager</Text>
      </View>
