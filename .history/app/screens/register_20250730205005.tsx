      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1 }} keyboardShouldPersistTaps="handled">
        <View className="flex-1 bg-white">
          ...
          <View className="absolute top-14 right-10">
            <Image source={require("../../assets/images/Smith_College_Hood.jpg")} className="w-32 h-32 rounded-full border-2 border-accent" />
          </View>
          ...
          <View className="flex bg-secondary">
            <View className="bg-white p-6 rounded-tr-[50px]">
              ...
              {/* Role Dropdown */}
              <Text className="text-primary text-lg mb-1 font-slabBold">Role</Text>
<Dropdown
