...
<View className="flex-1 bg-white">
  <View className="rounded-tr-[100px] pt-5" style={{ backgroundColor: colors.secondary }}>
      <Text className="font-slabBold text-7xl pl-14 pt-8" style={{color: colors.primary}}>EDU</Text>
  </View>
